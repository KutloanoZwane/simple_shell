...
/**
 * execAbsoluteCmd - this is a function to execute   command using execve
 * @cmd: user command to be executed
 * @argv: Array of the command line argument
 *
 * It is called when the command provided is an absolute path
 *
 */
...
/**
 * execCmdInPath - executes a command in a path
 * @cmd: user command to be executed
